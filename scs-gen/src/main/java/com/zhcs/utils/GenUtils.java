...
import com.zhcs.entity.ColumnEntity;
import com.zhcs.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		map.put("copyright", config.getString("copyright"));
		map.put("company", config.getString("company"));
		map.put("hasBigDecimal", hasBigDecimal);
		map.put("datetime", DateUtil.dateToStr(new Date(), DateUtil.DATE_CONSTANT));
		...
		for(String template : templates){
			...
			try {
				...
				throw new ZHCSException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig(){
		try {
			...
			throw new ZHCSException("获取配置文件失败，", e);
		}
	}
