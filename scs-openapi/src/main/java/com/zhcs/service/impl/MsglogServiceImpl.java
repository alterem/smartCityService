...
public class MsglogServiceImpl implements MsglogService {
	...
	@Override
	public List<MsglogEntity> queryList(Map<String, Object> map){
		return msglogDao.queryList(map);
	}
	...
	@Override
	public List<MsglogEntity> queryListBetweenTime(Map<String, Object> map) {
		return msglogDao.queryListBetweenTime(map);
	}
