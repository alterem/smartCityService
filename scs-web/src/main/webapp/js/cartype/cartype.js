$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '代码', name: 'code', width: 80 }, 
				{ label: '名称', name: 'nm', width: 80 }, 
				{ label: '排序', name: 'sort', width: 80 }, 
		// 状态
...
//			}},
			{ label: '备注', name: 'rmk', width: 80 }, 
				...
				var oper = "<a onClick=\"javascript:vm.update("+options.rowId+", flase);\" title='查看' ><i class=\"fa fa-info-circle\" style='color:violet;'></i></a>&nbsp;&nbsp;";
	...
	methods: {
		...
		del: function (id) {
			confirm('确定要删除选中的记录？', function(){
		    	$.get("../cartype/delete/"+id, function(r){
					if(r.code == 0){
