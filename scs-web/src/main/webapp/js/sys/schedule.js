$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: 'bean名称', name: 'bnm', width: 100 },
			{ label: '方法名称', name: 'mnm', width: 100 },
			{ label: '参数', name: 'params', width: 100 },
			{ label: 'cron表达式 ', name: 'cronexp', width: 100 },
...
var vm = new Vue({
	...
	methods: {
		...
		update: function () {
			...
			$.get("../sys/schedule/info/"+id, function(r){
				vm.showList = false;
                vm.title = "修改";
