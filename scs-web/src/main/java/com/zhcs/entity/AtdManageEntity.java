...
/*
申报类型（atdtype）有4个值 1、2、3、4，分别代表请假、加班、调班、调休
4个时间与申报类型对应关系：
      请假、加班：起始时间、停止时间、无意义、无意义
      调班：出勤时段（起始）、调整至（起始）
      调休：加班时段（起始）、抵扣出勤（起始）
请假类型ltype的值1-4分别表示：事假、病假、婚假、产假
 */
//*****************************************************************************
/**
 * <p>Title:AtdManageEntity</p>
 ...
 */
//*****************************************************************************
public class AtdManageEntity implements Serializable {
